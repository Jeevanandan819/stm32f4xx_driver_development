...
SRC_DIRS = . mcu/core/chip/src mcu/drivers/peripheral/src
...
DEFINES = -DDEBUG
CFLAGS = $(FLAGS) -Wall -Wextra -Wno-unused-parameter -O0 -g3 -ggdb -MD -std=gnu11 $(CPU_PARAMS) $(DEFINES)

STARTUP_FILE_PATH = Startup/startup_stm32f411retx.s
LINKER_SCRIPT_SRC = stm32f4xx_linker.ld
